...
L["FoxyFarmhelperOptions not found, loading defaults!"] = "FoxyFarmhelperOptions introuvable, paramètres par défaut chargés !"
...
FoxyFarmhelper:RegisterLocale("frFR", L)
L = nil