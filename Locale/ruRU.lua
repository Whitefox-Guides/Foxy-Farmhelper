...
L["FoxyFarmhelperOptions not found, loading defaults!"] = "Не найдены настройки FoxyFarmhelper, загружены настройки по умолчанию!"
...
FoxyFarmhelper:RegisterLocale("ruRU", L)
L = nil