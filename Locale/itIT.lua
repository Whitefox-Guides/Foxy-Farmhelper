...
L["FoxyFarmhelperOptions not found, loading defaults!"] = "FoxyFarmhelperOptions non trovato, carico le impostazioni predefinite!"
...
FoxyFarmhelper:RegisterLocale("itIT", L)
L = nil