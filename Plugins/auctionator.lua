...
if IsAddOnLoaded("Auctionator") then
    ...
    FoxyFarmhelper.ICON_LOCATIONS["AUCTIONATOR"] = {"LEFT", 0, 0}
    ...
    function AuctionatorFrame_CIMIUpdateIcon(self)
        ...
        if itemLink == nil then
            ...
            CIMI_SetIcon(self, AuctionatorFrame_CIMIUpdateIcon, FoxyFarmhelper.CANNOT_DETERMINE, FoxyFarmhelper.CANNOT_DETERMINE)
        else
            CIMI_SetIcon(self, AuctionatorFrame_CIMIUpdateIcon, FoxyFarmhelper:GetTooltipText(itemLink))
        end
    end
    ...
    function AuctionatorFrame_CIMIOnValueChanged(_, elapsed)
        ...
        if not FoxyFarmhelper.FrameShouldUpdate("AuctionatorShopping", elapsed or 1) then return end
        ...
        for i, button in pairs(buttons) do
            if button then
                ...
                AuctionatorFrame_CIMIUpdateIcon(button.FoxyFarmhelperOverlay)
            end
        end
    end
    ...
    FoxyFarmhelper.frame:AddEventFunction(HookOverlayAuctionator)
    ...
    FoxyFarmhelper.frame:AddEventFunction(AuctionatorUpdateEvents)
